  ...
  function getBannerText(alert: any): any {
    switch(alert.type) {
      ...
      case Events.Cheer:        
        return {
          banner: `Bits! Cheers!`, 
          footer: `${alert.data.bitCount} bits from ${alert.data.cheererName}!`,
      ...
      default:
        return {
          ...
          footer: 'eeeeeee',
          imgAlt: 'whitep4nth3r', 
          logoUrl: 'https://static-cdn.jtvnw.net/jtv_user_pictures/69ade2a2-82e1-477c-afc6-43582bf2844c-profile_image-300x300.png'
        };
    }
  }
...
<div class="alert">  
  <div class="alert__banner">
    ...
    <svg class="alert__bannerTextPath" width="800" height="244" viewBox="0 0 800 244" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text class="alert__subtitle" width="800" text-anchor="middle" x="400" >
  ...
  <img src={displayText.logoUrl} alt={displayText.imgAlt} class="alert__logo" />
